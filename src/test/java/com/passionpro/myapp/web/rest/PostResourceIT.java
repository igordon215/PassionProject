...
import static com.passionpro.myapp.domain.PostAsserts.*;
...
import com.passionpro.myapp.domain.Post;
import com.passionpro.myapp.repository.PostRepository;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).created_at(DEFAULT_CREATED_AT).media_url(DEFAULT_MEDIA_URL);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT).media_url(UPDATED_MEDIA_URL);
        return post;
    }
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].media_url").value(hasItem(DEFAULT_MEDIA_URL)));
    }
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.media_url").value(DEFAULT_MEDIA_URL));
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT).media_url(UPDATED_MEDIA_URL);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.created_at(UPDATED_CREATED_AT).media_url(UPDATED_MEDIA_URL);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT).media_url(UPDATED_MEDIA_URL);
