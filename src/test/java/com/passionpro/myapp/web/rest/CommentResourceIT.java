...
import static com.passionpro.myapp.domain.CommentAsserts.*;
...
import com.passionpro.myapp.domain.Comment;
import com.passionpro.myapp.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).created_at(DEFAULT_CREATED_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).created_at(UPDATED_CREATED_AT);
