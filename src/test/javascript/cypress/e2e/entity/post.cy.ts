...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'pressurize mmm baseboard', content: 'blah' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('past kiddingly pro');
      cy.get(`[data-cy="title"]`).should('have.value', 'past kiddingly pro');

      cy.get(`[data-cy="content"]`).type('until underneath regarding');
      cy.get(`[data-cy="content"]`).should('have.value', 'until underneath regarding');

      cy.get(`[data-cy="created_at"]`).type('2024-08-19T18:31');
      cy.get(`[data-cy="created_at"]`).blur();
      cy.get(`[data-cy="created_at"]`).should('have.value', '2024-08-19T18:31');

      cy.get(`[data-cy="media_url"]`).type('apropos');
      cy.get(`[data-cy="media_url"]`).should('have.value', 'apropos');
