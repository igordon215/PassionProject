...
describe('Comment e2e test', () => {
  ...
  const commentSample = { content: 'propagandise wherever loggia' };
  ...
  describe('new Comment page', () => {
    ...
    it('should create an instance of Comment', () => {
      cy.get(`[data-cy="content"]`).type('beneficiary quintessential');
      cy.get(`[data-cy="content"]`).should('have.value', 'beneficiary quintessential');

      cy.get(`[data-cy="created_at"]`).type('2024-08-19T19:45');
      cy.get(`[data-cy="created_at"]`).blur();
      cy.get(`[data-cy="created_at"]`).should('have.value', '2024-08-19T19:45');
