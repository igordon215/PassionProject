          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('media_url')}>
                  Media Url <FontAwesomeIcon icon={getSortIconByFieldName('media_url')} />
                </th>
                <th>
                  User <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Forum Post <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {postList.map((post, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{post.forumPost ? <Link to={`/forum-post/${post.forumPost.id}`}>{post.forumPost.name}</Link> : ''}</td>
