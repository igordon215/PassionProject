...
export const ForumPostDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/forum-post' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="passionProjectApp.forumPost.delete.question">
        Are you sure you want to delete Forum Post {forumPostEntity.id}?
      </ModalBody>
      <ModalFooter>
